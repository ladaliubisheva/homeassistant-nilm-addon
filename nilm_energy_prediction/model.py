...
db_path = "/config/home-assistant_v2.db"  # Adjust path for Windows/Linux/Mac
model_path = "/addons/local/nilm_energy_prediction/nilm_rf_model.pkl"    
...
def serve_plot():
    ...
    ax.set_title(f'Energy Consumption for {last_day}: Main Meter + Predicted Appliances (15-Minute Intervals)')
    ax.legend()
